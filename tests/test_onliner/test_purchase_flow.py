...
class TestVinylTurntable:
    ...
    @allure.description("Scenario 1: Buy vinyl turntable")
    ...
    def test_purchase_flow_of_vinyl_turntable(self, main_page, catalog_page, popup, filter_catalog_view, product_page,
        ...
        product_page.product_added_flag()
        ...
        assert "Audio-Technica AT-LP140XP-BK" == checkout_page.get_title_of_product, \
            f"Expected header: 'Audio-Technica AT-LP140XP-BK', Actual: {checkout_page.get_title_of_product}"
